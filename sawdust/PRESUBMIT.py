...
#
# Presubmit script for Sawdust.
import os

UNITTEST_MESSAGE_ = '''\
Your %s unittests must succeed before submitting.
To clear this presubmit error, build the sawdust/run_unittests target
in the solution file sawdust/sawdust.sln, or run sawdust/run_all_tests.bat
'''
