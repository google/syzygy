...
#ifndef SYZYGY_CALL_TRACE_CALL_TRACE_CLIENT_H_
#define SYZYGY_CALL_TRACE_CALL_TRACE_CLIENT_H_
...
extern "C" void _cdecl _penter_hook();
extern "C" void _cdecl _indirect_penter_hook();
extern void pexit_hook();
extern bool wait_til_enabled();
extern bool wait_til_disabled();

class CallTraceClient {
 public:
  CallTraceClient();
  ~CallTraceClient();

  static BOOL WINAPI DllMain(DWORD reason, LPVOID reserved);

 protected:
  friend void _penter_hook();
  friend void pexit_hook();
...
#endif  // SYZYGY_CALL_TRACE_CALL_TRACE_CLIENT_H_
