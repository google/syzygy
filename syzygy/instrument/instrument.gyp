  ...
  'targets': [
    {
      ...
      'sources': [
        'instrument_app.cc',
        'instrument_app.h',
        'instrumenter_with_agent.cc',
        'instrumenter_with_agent.h',
        'instrumenter.h',
        ...
        'transforms/fuzzing_transform.cc',
        'transforms/fuzzing_transform.h',
    ...
    },
    {
      ...
      'sources': [
        ...
        'instrumenter_with_agent_unittest.cc',
        ...
        'transforms/fuzzing_transform_unittest.cc',
