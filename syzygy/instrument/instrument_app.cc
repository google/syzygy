...
static const char kUsageFormatStr[] =
    ...
    "                            debug but much more memory and time\n"
    "                            efficient. Only affects the new decomposer.\n"
    ...
    "  asan mode options:\n"
    "    --intercept-crt-functions\n"
    "                            Intercept the CRT functions like memset,\n"
    "                            memcpy, stcpy... to check their parameters.\n"
