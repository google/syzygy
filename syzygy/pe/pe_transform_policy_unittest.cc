...
TEST(PETransformPolicyTest, CodeBlockAttributesAreBasicBlockSafe) {
...
TEST(PETransformPolicyTest, CodeBlockIsSafeToBasicBlockDecompose) {
  PETransformPolicy policy;
  BlockGraph bg;
  BlockGraph::Block* b = bg.AddBlock(BlockGraph::CODE_BLOCK, 1, "");
...
TEST(PETransformPolicyTest, ReferenceIsSafeToRedirect) {
  PETransformPolicy policy;
  BlockGraph bg;
  BlockGraph::Block* b = bg.AddBlock(BlockGraph::CODE_BLOCK, 1, "");
