...
bool Decomposer::CreateCodeReferencesForBlock(BlockGraph::Block* block) {
  ...
  // NOTE: This is particularly ugly. Decomposer should not depend on the
  //     transform policy object. In fact, Decomposer should not even be doing
  //     disassembly. This all disappears in the new decomposer.
