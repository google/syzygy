...
TEST_F(DecomposerTest, Decompose) {
  ...
  // Official build.
  expected_section_counts[static_cast<unsigned>(-1)] = 2;
  expected_section_counts[0] = 513;
  expected_section_counts[1] = 863;
  expected_section_counts[2] = 90;
  expected_section_counts[3] = 17;
...
#ifndef NDEBUG
  // Debug build.
  expected_block_type_counts[BlockGraph::CODE_BLOCK] = 563;
...
#else
  // Official build.
  expected_block_type_counts[BlockGraph::CODE_BLOCK] = 513;
  expected_block_type_counts[BlockGraph::DATA_BLOCK] = 975;
#endif
#endif
...
TEST_F(DecomposerTest, LabelsAndAttributes) {
  ...
  expected_attrib_counts[BlockGraph::SECTION_CONTRIB] = 1562;
  ...
  expected_attrib_counts[BlockGraph::NON_RETURN_FUNCTION] = 8;
  expected_attrib_counts[BlockGraph::PE_PARSED] = 99;
  expected_attrib_counts[BlockGraph::SECTION_CONTRIB] = 1484;
  expected_attrib_counts[BlockGraph::BUILT_BY_UNSUPPORTED_COMPILER] = 153;
  expected_attrib_counts[BlockGraph::HAS_INLINE_ASSEMBLY] = 16;
  expected_attrib_counts[BlockGraph::HAS_EXCEPTION_HANDLING] = 28;
  expected_attrib_counts[BlockGraph::THUNK] = 8;
  expected_attrib_counts[BlockGraph::COFF_GROUP] = 8;
...
TEST_F(DecomposerTest, DecomposeTestDllMSVS2010) {
