...
; Declare a single top-level function housing all of the probes. This makes it
; easy to generate a single table with pointers to every shadow memory reference
; in the probes.
asan_probes PROC
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_1_byte_read_access LABEL PROC  ; Probe #0.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_1_byte_write_access LABEL PROC  ; Probe #1.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_2_byte_read_access LABEL PROC  ; Probe #2.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_2_byte_write_access LABEL PROC  ; Probe #3.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_4_byte_read_access LABEL PROC  ; Probe #4.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_4_byte_write_access LABEL PROC  ; Probe #5.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_8_byte_read_access LABEL PROC  ; Probe #6.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_8_byte_write_access LABEL PROC  ; Probe #7.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_10_byte_read_access LABEL PROC  ; Probe #8.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_10_byte_write_access LABEL PROC  ; Probe #9.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_16_byte_read_access LABEL PROC  ; Probe #10.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_16_byte_write_access LABEL PROC  ; Probe #11.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_32_byte_read_access LABEL PROC  ; Probe #12.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; in particular it saves and restores EFLAGS.
  ALIGN 16
  asan_check_32_byte_write_access LABEL PROC  ; Probe #13.
    ; Save the EFLAGS.
    push eax
    lahf
    seto al
  ...
  ; all other registers.
  asan_check_1_byte_read_access_no_flags LABEL PROC  ; Probe #14.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_1_byte_write_access_no_flags LABEL PROC  ; Probe #15.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_2_byte_read_access_no_flags LABEL PROC  ; Probe #16.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_2_byte_write_access_no_flags LABEL PROC  ; Probe #17.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_4_byte_read_access_no_flags LABEL PROC  ; Probe #18.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_4_byte_write_access_no_flags LABEL PROC  ; Probe #19.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_8_byte_read_access_no_flags LABEL PROC  ; Probe #20.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_8_byte_write_access_no_flags LABEL PROC  ; Probe #21.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_10_byte_read_access_no_flags LABEL PROC  ; Probe #22.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_10_byte_write_access_no_flags LABEL PROC  ; Probe #23.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_16_byte_read_access_no_flags LABEL PROC  ; Probe #24.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_16_byte_write_access_no_flags LABEL PROC  ; Probe #25.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_32_byte_read_access_no_flags LABEL PROC  ; Probe #26.
    push edx
    sar edx, 3
  ...
  ; and popped off the stack. This function may modify EFLAGS, but preserves
  ; all other registers.
  asan_check_32_byte_write_access_no_flags LABEL PROC  ; Probe #27.
    push edx
    sar edx, 3
