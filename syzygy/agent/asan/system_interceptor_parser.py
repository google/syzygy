...
_GENERATED_MESSAGE = """
; This file is generated by asan_system_interceptor_parser.py, DO NOT MODIFY.\
"""
...
class AsanSystemInterceptorGenerator(object):
  ...
  def __init__(self, output_base, def_file, overwrite=False):
    ...
    self._output_impl_file.write(_HEADER)

    self._output_instrumentation_filter_file =  \
        open(output_instrumentation_filter_filename, 'wb')
    self._output_instrumentation_filter_file.write(_HEADER)
