...
_GENERATED_MESSAGE = """
{c} This file is generated by %(script)s, DO NOT MODIFY.
{c} Regenerate this file by running syzygy/agent/asan/generate_files.bat.
""" % {'script': os.path.basename(__file__)}


_HEADER = """\
{c} Copyright %(year)d Google Inc. All Rights Reserved.
{c}
...
class SystemInterceptorGenerator(object):
  ...
  def __init__(self, output_base, def_file, overwrite=False):
    ...
    self._output_impl_file.write(_HEADER.format(c='//'))
