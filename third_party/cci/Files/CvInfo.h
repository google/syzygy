...
static_assert(sizeof(int) == 4, "Size of int must be 4 bytes.");
  ...
  /*internal*/ struct CV_PRIMITIVE_TYPE {
    static const uint CV_MMASK     = 0x700;       // mode mask
    static const uint CV_TMASK     = 0x0f0;       // type mask
    static const uint CV_SMASK     = 0x00f;       // subtype mask
    ...
    //  return (((CV_TYPE(typ) == CV_type.CV_UNSIGNED) 
    ...
    static const uint CV_FIRST_NONPRIM = 0x1000;
  ...
  /*internal*/ struct LeafArray {
    ...
    /*internal*/ byte data[1];  // variable length data specifying size in bytes
  ...
  /*internal*/ struct LeafClass {
    ...
    /*internal*/ ushort property;   // property attribute field (prop_t)
    /*internal*/ uint field;  // type index of LF_FIELD descriptor list
    /*internal*/ uint derived; // (type index) type index of derived from list
                               // if not zero
    /*internal*/ uint vshape;  // (type index) type index of vshape table for
                               // this class
    /*internal*/ byte data[1]; // data describing length of structure in bytes
    //internal string name;
  };
  ...
  /*internal*/ struct LeafUnion {
    ...
    /*internal*/ uint field;  // (type index) type index of LF_FIELD descriptor
                              // list
    /*internal*/ byte data[1];       // variable length data describing length of
    //internal string name;
  };
  ...
  /*internal*/ struct LeafMFunc {
    ...
    /*internal*/ uint thistype;   // (type index) type index of this pointer
                              // (model specific)
    /*internal*/ byte calltype;   // calling convention (call_t)
    /*internal*/ byte reserved;   // reserved for future use
    /*internal*/ ushort parmcount;  // number of parameters
    /*internal*/ uint arglist;    // (type index) type index of argument list
    /*internal*/ int thisadjust; // this adjuster (long because pad required
                                 // anyway)
  };
  ...
  /*internal*/ struct LeafVTShape {
    ...
    /*internal*/ byte desc[1];       // 4 bit (CV_VTS_desc) descriptors
  };
  ...
  /*internal*/ struct LeafVFTPath {
    ...
    /*internal*/ uint bases[1];      // (type index) bases from root to leaf
  };
  ...
  /*internal*/ struct LeafOEM {
    ...
    /*internal*/ uint index[1];  // (type index) array of type indices followed
    // by OEM defined data
  };
  ...
  /*internal*/ struct LeafArgList {
    ...
    /*internal*/ uint arg[1];        // (type index) number of arguments
  };
  ...
  /*internal*/ struct LeafDerived {
    ...
    /*internal*/ uint count;      // number of arguments
    /*internal*/ uint drvdcls[1];// (type index) type indices of derived classes
  };
  ...
  /*internal*/ struct LeafDefArg {
    ...
    /*internal*/ byte expr[1];       // length prefixed expression string
  };
  ...
  /*internal*/ struct LeafList {
    ...
    /*internal*/ byte data[1];       // data format specified by indexing type
  };
  ...
  /*internal*/ struct LeafFieldList {
    ...
    /*internal*/ char data[1];       // field list sub lists
  };
  ...
  /*internal*/ struct mlMethod {
    ...
    /*internal*/ uint vbaseoff[1];   // offset in vfunctable if intro virtual
  };

  /*internal*/ struct LeafMethodList {
    // internal ushort leaf;      // LF_METHODLIST [TYPTYPE]
    /*internal*/ byte mList[1];      // really a mlMethod type
  };
  ...
  /*internal*/ struct LeafDimCon {
    ...
    /*internal*/ byte dim[1];        // array of dimension information with
  ...
  /*internal*/ struct LeafDimVar {
    ...
    /*internal*/ uint typ;        // (type index) type of index
    /*internal*/ uint dim[1];   // (type index) array of type indices for either
  ...
  /*internal*/ struct LeafRefSym {
    ...
    /*internal*/ byte Sym[1];        // copy of referenced symbol record
    // (including length)
  };
  ...
  /*internal*/ struct LeafBClass {
    ...
    /*internal*/ byte offset[1];  // variable length offset of base within class
  };
  ...
  /*internal*/ struct LeafVBClass {
    ...
    /*internal*/ ushort attr;       // (CV_fldattr_t) attribute
    /*internal*/ uint index; // type index of direct virtual base class
    /*internal*/ uint vbptr;  // (type index) type index of virtual base pointer
    /*internal*/ byte vbpoff[1];  // virtual base pointer offset from address
                                  // point
  ...
  /*internal*/ struct LeafFriendFcn {
    ...
    /*internal*/ ushort pad0;       // internal padding, must be 0
    /*internal*/ uint index; // index to type record of friend function
  ...
  /*internal*/ struct LeafMember {
    ...
    /*internal*/ byte offset[1];     // variable length offset of field
  ...
  /*internal*/ struct LeafEnumerate {
    ...
    /*internal*/ byte value[1];      // variable length value field
    //internal string name;
  };
  ...
  /*internal*/ enum SYM {
    ...
    S_DEFRANGE=0x1134,  // defines a single range of addresses in which symbol
                        // can be evaluated
    S_DEFRANGE2=0x1135, // defines ranges of addresses in which symbol
                        // can be evaluated
  ...
  /*internal*/ enum CV_PROCFLAGS/* : byte */{
    ...
    CV_PFLAG_OPTDBGINFO=0x80, // function has debug information for optimized
                              // code
  };
  ...
  /*internal*/ struct ManyRegSym {
    ...
    /*internal*/ byte reg[1];      // count register enumerates, most-sig first
    /*internal*/ string name;       // length-prefixed name.
  };
  ...
  /*internal*/ struct ManyRegSym2 {
    ...
    /*internal*/ ushort reg[1];     // count register enumerates, most-sig first
    /*internal*/ string name;       // length-prefixed name.
  };
  ...
  /*internal*/ struct ConstSym {
    ...
    /*internal*/ uint typind;     // (type index) Type index (containing enum if
                              // enumerate) or metadata token
  ...
  /*internal*/ struct CompileSym {
    ...
    /*internal*/ string verSt;      // Length-prefixed compiler version string.
    /*internal*/ string verArgs[1];    // block of zero terminated strings,
                                    // ended by double-zero.
  };
  ...
  /*internal*/ struct AnnotationSym {
    ...
    /*internal*/ string rgsz[1];  // Sequence of zero terminated annotation
                                  // strings
  };

  /*internal*/ struct DatasSym32 {
    // internal ushort reclen;    // Record length [SYMTYPE]
    // internal ushort rectyp;    // S_LDATA32, S_GDATA32 or S_PUB32,
                                  //S_LMANDATA, S_GMANDATA
    /*internal*/ uint typind; // (type index) Type index, or Metadata token if a
                              // managed symbol
    /*internal*/ uint off;
    /*internal*/ ushort seg;
    /*internal*/ string name;       // Length-prefixed name
  ...
  /*internal*/ struct ManProcSym {
    // internal ushort reclen;    // Record length [SYMTYPE]
    // internal ushort rectyp;    // S_GMANPROC, S_LMANPROC, S_GMANPROCIA64 or
                                  // S_LMANPROCIA64
    /*internal*/ uint parent;     // pointer to the parent
    /*internal*/ uint end;        // pointer to this blocks end
    /*internal*/ uint next;       // pointer to next symbol
    ...
    /*internal*/ ushort seg;
    /*internal*/ byte flags;      // (CV_PROCFLAGS) Proc flags
    /*internal*/ ushort retReg;  // Register return value is in (may not be used
                                 // for all archs)
  ...
  /*internal*/ struct ThunkSym32 {
    ...
    /*internal*/ string name;       // Length-prefixed name
    /*internal*/ byte variant[1];    // variant portion of thunk
  };
  ...
  /*internal*/ struct Slink32 {
    ...
    /*internal*/ int off;       // signed offset where the static link was saved
                                // relative to the value of reg
    /*internal*/ ushort reg;
  };
  ...
  /*internal*/ struct OemSymbol {
    ...
    /*internal*/ Guid idOem;      // an oem ID (GUID)
    /*internal*/ uint typind;     // (type index) Type index
    /*internal*/ byte rgl[1];        // user data, force 4-byte alignment
  };
  ...
  /*internal*/ enum FRAMEPROCSYM_FLAGS/* : uint */{
    ...
    //fSecurityChecks=0x00000100,   // function has buffer security check
                                    // introduced by /GS.
    fAsyncEH=0x00000200,   // function compiled with /EHa
    fGSNoStackOrdering=0x00000400,   // function has /GS buffer checks, but 
  ...
  /*internal*/ struct LocalSym {
    ...
    /*internal*/ uint typind;     // (type index) type index
    /*internal*/ ushort flags;    // (CV_LVARFLAGS) local var flags
    /*internal*/ uint idParent;   // This is is parent variable - fIsAggregated 
                                  // or fIsAlias
  ...
  /*internal*/ struct DefRangeSym {
    ...
    /*internal*/ uint id;     // ID of the local symbol for which this formula
                              // holds
    /*internal*/ uint program;    // program to evaluate the value of the symbol

    /*internal*/ CV_lvar_addr_range range; // Range of addresses where this
                                           // program is valid
  };
  ...
  /*internal*/ struct DefRangeSym2 {
    ...
    /*internal*/ CV_lvar_addr_range range[1]; // Range of addresses where this
                                          // program is valid
  };
  ...
  /*internal*/ struct CallsiteInfo {
    ...
    /*internal*/ uint typind;     // (type index) type index describing function
                              // signature
  };
  ...
  /*internal*/ struct DiscardedSym {
    ...
    /*internal*/ byte data[1];       // Original record(s) with invalid indices
  };
  ...
  /*internal*/ enum CV_Line_Flags/* : uint */{
    ...
    fStatement=0x80000000,   // true if a statement linenumber, else an
                             // expression line num
  };
